...
opt=/opt/JeonInstaller
repair=/opt/JeonInstaller/repair
installed=/opt/JeonInstaller/installed
#---------
...
echo "NE"
echo
mkdir /opt/JeonInstaller
mkdir /opt/JeonInstaller/repair
mkdir /opt/JeonInstaller/installed
fi
...
sleep 3s
echo "" > /dev/null
echo "Installed." > /opt/JeonInstaller/installed/$nombre.txt
exit
fi
